...
This was a task as part of my Ai Core data course. The task was to create a linear regression module with stochastic gradient descent from sratch, not using the sklearn package. This task used the california housing dataset for trianing purposes. This aim of this exercise was to enhance my understanding of linear regression and gradient descent optimisation.

To complete this task I created 2 seperate classes in LinearRegression and SGDOptimiser as can be seen below.
